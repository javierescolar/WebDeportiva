        ...
        <div class="container">
            <div class="col-md-6 col-md-offset-3">
                ...
                <h4 class="col-md-6">Jornada 
                    <?php echo $session->getSesion('jornadaPagina'); ?>
                    <small><?php echo date("d-m-Y", strtotime($jornada->getFecha())); ?></small>
                </h4>
                <form class="form col-md-6" action="index.php" method="POST">
                    <input type="submit" class="col-md-offset-9 btn btn-link" name="verJornadas" value="Volver"> 
                </form>
                </div>
                 <form class="form" action="index.php" method="POST"> 
                <?php
                include 'vistas/partials/tablaJornadaActual.php';
                ?>
                <div class="col-md-5">
